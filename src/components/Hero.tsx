...
const Hero: React.FC = () => {
    ...
    return (
        <section className="relative min-h-screen flex items-center justify-center pt-16 overflow-hidden">
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center z-10 w-full pointer-events-none">
                <div className="pointer-events-auto"> {/* Enable interaction for nested elements if needed */}
                    <motion.div
                    ...
                    >
                        ...
                        <p className="max-w-2xl mx-auto text-gray-400 text-lg md:text-xl mb-12 leading-relaxed backdrop-blur-sm bg-black/10 rounded-xl p-4">
                        ...
                        <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
                            <button
                                ...
                                className="group relative px-8 py-4 bg-black/50 overflow-hidden rounded-md transition-all duration-300 hover:scale-105 border border-neon-cyan/50 hover:border-neon-cyan"
                            >
                            ...
                            <button
                                ...
                                className="group relative px-8 py-4 bg-black/50 hover:bg-black/70 rounded-md transition-all duration-300 hover:scale-105 border border-white/10 hover:border-white/20"
                            >
